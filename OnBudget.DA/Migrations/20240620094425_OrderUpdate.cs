    ...
    public partial class OrderUpdate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Suppliers", x => x.Handle);
                    table.ForeignKey(
                        name: "FK_Suppliers_Shippers_ShipperId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SupplierHandle = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Products_Suppliers_SupplierHandle",
                        column: x => x.SupplierHandle,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_SupplierHandle",
                table: "Products",
                column: "SupplierHandle");

            migrationBuilder.CreateIndex(
                name: "IX_Suppliers_ShipperId",
                table: "Suppliers",
                column: "ShipperId");
        }
